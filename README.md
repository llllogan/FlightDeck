...
Open http://localhost:8080 and create an account. Stop it with `docker compose down`; the database persists. To remove everything deliberately, run `docker compose down -v`.
